...
<html>
    <head>
    <title>Plantilla 2 - @yield('title')</title>
...
<!-- encabezado-->
<header class="masthead" style="background-image: url('https://static.eldiario.es/clip/878ce8a8-f1c6-441c-98ba-cb1b3378be4e_16-9-discover-aspect-ratio_default_0.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="post-heading text-light">
                            <h1>La UE se abre a todo tipo de medidas para intervenir el mercado desde ya ante los cortes de gas ruso</h1>
                            <h2 class="subheading">Andrés Gil</h2>
                            <span class="meta">
                                Posted by
